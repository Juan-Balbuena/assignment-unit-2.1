...
let food = 'tacos'
console.log(food);
let sentence = 'My favorite type of food are ' + food;
console.log(sentence );
// 8 - Create a variable called `pets` and set it to the value of the number of pets you have
//     Console log the value of `pets`
let pets = 3
console.log(pets);
console.log( 'Total number of pets I have is ' + pets );

// 9 - Create a variable called `friendsPets` and assign it the value of the number of pets your friend has
let friendsPets = 3
console.log(friendsPets);
console.log( 'Total number of pets my friend has is ' + friendsPets );

// 10 - Add two pets to your `pets` variable
pets += 2
console.log(pets);
console.log( 'Adding two more pets to my collection and now I have ' + pets );

// 11 - Create a constant variable called `allowedPets` and set it to a number value of your choice
let allowedPets = 6
console.log(allowedPets);
console.log( 'Total number of pets allowed is ' + allowedPets );
